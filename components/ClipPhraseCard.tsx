...
interface ClipPhraseCardProps {
  phrase: Phrase
  highlightRanges?: Array<{ start: number; end: number }>
}

export default function ClipPhraseCard({ phrase, highlightRanges = [] }: ClipPhraseCardProps) {
    ...
    <div className="bg-white border-2 border-gray-200 rounded-xl p-5 space-y-4">
      ...
      <div className="flex items-center space-x-3 pt-2 border-t border-gray-200">
        ...
        <button
          onClick={handleLoop}
          className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${
            isLooping ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700 active:bg-gray-200'
          }`}
          aria-label="Loop"
        >
          <span className="text-lg">🎯</span>
