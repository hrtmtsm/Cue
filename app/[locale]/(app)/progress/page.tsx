    ...
    <main className="flex flex-col px-6 py-6">
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600">{t('progress.subtitle')}</p>
        </div>
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">{t('progress.allTime')}</h2>
          
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
              <div className="text-sm text-gray-600 mb-1">{t('progress.totalClips')}</div>
            ...
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
              <div className="text-sm text-gray-600 mb-1">{t('progress.storiesCompleted')}</div>
              <div className="text-2xl font-bold text-gray-900">
                {totalSessions}
              </div>
              <div className="text-xs text-gray-500 mt-1">
