...
export default function AuthChoicePage() {
  ...
  const handleEmail = () => {
    router.push(`/${locale}/auth/signup/email`)
  }
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-12">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <button
          onClick={handleEmail}
          className="w-full bg-white border-2 border-gray-300 text-gray-900 text-center font-semibold py-4 px-6 rounded-xl hover:bg-gray-50 active:bg-gray-100 transition-colors"
        >
